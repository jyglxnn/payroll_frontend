...
export default function EditRulePage(){
    ...
    const executeDelete = async () => {
        const deletePromise = WageService.deleteDeduction(ruleId);
    ...
    const handleUpdate = async () => {
        const updatePromise = WageService.updateDeduction(ruleId, {
            name: formData.name,
    ...
    const fetchRuleData = useCallback(async () => {
        ...
        try {
            setIsLoading(true);
            const data = await WageService.getDeductionId(ruleId);
