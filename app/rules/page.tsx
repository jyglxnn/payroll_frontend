    ...
    return (
        <div className="p-8">
            ...
            {isLoading? (
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 w-[80vw] md:max-w-2xl gap-2 py-8">
                    {[
                            ...
                            <li key={salary.id} className="flex bg-white items-center justify-between border border-gray-200 p-3 md:p-4 rounded-lg shadow-sm">
                                ...
                                <div className="flex items-center gap-2 sm:gap-6 shrink-0 ml-3">
                                    <div className="text-right">
                                        ...
                                        <div><span className="text-[10px] md:text-xs uppercase font-bold tracking-tight"> / {salary.base?.replace('ly', '')}</span></div>
                                    </div>
